        ...
        <footer className="bg-gray-800 text-white py-12 mt-16">
            <div className="container mx-auto px-4 max-w-7xl text-center">
                ...
                <p className="text-gray-300 mb-6 max-w-2xl mx-auto">
                    Join the next cohort of Software for Climate and learn to build impactful
                    climate tech projects like these. Transform your skills into real-world climate
                    solutions.
                </p>
                <a
